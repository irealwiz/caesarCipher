 ...
 * <p><strong>!!! Внимание:</strong> Ни в коем случае не применяйте шифр Цезаря для защиты любых данных. Этот шифр абсолютно небезопасен и очень легко вскрывается. Данная реализация, создана исключительно с целью развлечения, и <em>намеренно</em> хранит алфавит и ключ (сдвиг) в открытом виде, с целью подчёркивания того, что шифрование шифром Цезаря аналогично полному отсутствию любого шифрования.</p>
